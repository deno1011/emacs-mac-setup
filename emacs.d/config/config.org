...
Per-Mac and account-specific values are NOT kept in a config file; they
live in the macOS Keychain (e.g. the iCloud CalDAV wiring via
=M-x my/caldav-setup=, see [[file:modules/55_calendar.org][modules/55_calendar.org]]).
