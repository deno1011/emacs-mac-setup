...
The setup's external-provisioning module installs Playwright and Chromium in a
user-local virtual environment.  The manual command remains available for a
repair/re-install after a deliberate local change.
