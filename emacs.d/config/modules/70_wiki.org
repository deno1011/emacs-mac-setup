...
- Built on top of [[file:40-org.org][org-roam]] and [[file:60_emacs-agent-runtime.org][gptel/EAR]]
...
ingests. The directive is independent from EAR's default gptel runtime
directive; the helpers below opt in explicitly per buffer.
...
Watch the gptel buffer or the [[file:40-org.org][org-roam-ui]] graph for the result.
