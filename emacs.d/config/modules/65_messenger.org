...
#+begin_example
git clone https://github.com/deno1011/whatsapp-bridge-adapter.git <private-data-repo>/ear-extensions/adapters/whatsapp-bridge-adapter
cd <private-data-repo>/ear-extensions/adapters/whatsapp-bridge-adapter
npm install
cp .env.example .env
#+end_example
...
git clone https://github.com/deno1011/signal-bridge-adapter.git <private-data-repo>/ear-extensions/adapters/signal-bridge-adapter
cd <private-data-repo>/ear-extensions/adapters/signal-bridge-adapter && npm install
