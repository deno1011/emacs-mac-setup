...
The setup exposes one EAR declaration entry point.  The workspace's
=shared/settings/layers.eld= may add further roots, such as personal
declarations, through the same generic loader:
