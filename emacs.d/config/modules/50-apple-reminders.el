...
(when (and (eq system-type 'darwin)
  ...
  (use-package org-apple-reminders
    ...
    ;; Self-ensure the sync-file's parent directory exists. A freshly
    ;; cloned data repo may not carry data/org/ yet, and `org-apple-
    ;; reminders-setup' registers timers that touch this path. Idempotent.
    (let ((d (file-name-directory org-apple-reminders-sync-file)))
