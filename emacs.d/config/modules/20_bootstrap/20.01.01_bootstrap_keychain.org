...
;;   (my/keychain-set-internet SERVER ACCOUNT VALUE)     → :ok or (:error MSG)
;;
...
** =my/keychain-get-internet= — single Internet-password read
...
** =my/keychain-set-internet= — write or update one Internet-password entry

#+begin_src emacs-lisp :tangle yes
(defun my/keychain-set-internet (server account value)
