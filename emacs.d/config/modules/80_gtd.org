...
Kalender, Review-Rituale) automatisch — **ohne** wissen zu müssen, dass es sie
gibt. Alles läuft über die **gekapselte Paket-API** (org-apple-reminders /
...
mit angelegt (leer); Habit-Inhalte/Reminder bleiben deine Wahl.
