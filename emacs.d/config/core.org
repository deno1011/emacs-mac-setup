...
(add-hook 'org-mode-hook
          (lambda ()
            (when (and buffer-file-name
                       my/data-dir
                       ;; Auto-commit user data (data/org/) only. The
                       ;; literate distro config under my/config-dir is
                       ;; symlinked and shouldn't be auto-committed from
                       ;; an org-mode hook.
                       (string-match-p
                        (regexp-quote (expand-file-name "data/org/" my/data-dir))
                        buffer-file-name)
