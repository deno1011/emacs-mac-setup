...
(defun my/gptel-tools-all ()
  ...
  (delq nil (mapcar (lambda (e)
                      (when (gptel-tool-p (cdr e)) (cdr e)))
                    gptel--known-tools)))

(defun my/gptel-ensure-tools (&rest _)
  "Activate all registered tools before each gptel request if none are set."
...
(with-eval-after-load 'gptel
  (advice-add 'gptel-send :before #'my/gptel-ensure-tools))
#+end_src
