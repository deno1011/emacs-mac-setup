...
;; Auto-install system packages via brew (Mac) or apt (Linux/Docker)
(use-package system-packages
  :ensure t
  :custom
  (system-packages-package-manager
   (if (executable-find "brew") 'brew 'apt))
...
(unless (find-font (font-spec :name "JetBrains Mono"))
  (when (executable-find "brew")
    (start-process "install-font" "*install-font*"
...
(unless (executable-find "latex")
  (when (executable-find "brew")
    (start-process "install-texlive" "*install-texlive*" "brew" "install" "texlive")
