...
- *reminders-cli*: =brew install keith/formulae/reminders-cli=
  (dasselbe CLI das auch =apple-reminders.el= verwendete)
- *Emacs 29+*: für =package-vc-install= (in Emacs integriert, kein extra Package-Manager nötig)
- *org-mode*: bereits geladen

** Installation & Konfiguration

#+begin_src emacs-lisp :tangle yes
;;; Apple Reminders via org-reminders package
;;; Voraussetzung: brew install keith/formulae/reminders-cli

;; Sicherstellen dass reminders-cli vorhanden ist
(unless (executable-find "reminders")
  (message "org-reminders: reminders-cli fehlt — bitte installieren: brew install keith/formulae/reminders-cli"))

;; Package von GitHub installieren (Emacs 29+ package-vc-install)
(use-package org-reminders
  ...
  :config
  ;; Org-Datei in die Apple Reminders synchronisiert werden
  (setq org-reminders-reminders-to-org-file
        (expand-file-name "~/org/reminders.org"))
  ;; Agenda-Datei einbinden damit Reminders im org-agenda erscheinen
