...
;; Python-Abhängigkeit installieren (my/pip-install-and-log aus core.org)
(when (fboundp 'my/pip-install-and-log)
  (my/pip-install-and-log "websocket-bridge-python"))

(when (fboundp 'package-vc-install)
  ;; websocket-bridge zuerst (Abhängigkeit von org-reminders)
  (unless (package-installed-p 'websocket-bridge)
    (package-vc-install "https://github.com/ginqi7/websocket-bridge"))
  ;; org-reminders selbst
  (unless (package-installed-p 'org-reminders)
    (package-vc-install "https://github.com/ginqi7/org-reminders")))
