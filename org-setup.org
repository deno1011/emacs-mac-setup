...
(use-package org
  :ensure nil
  :config
  (setq org-directory "~/emacs-data/data/org"
        org-default-notes-file "~/emacs-data/data/org/inbox.org"
        org-agenda-files '("~/emacs-data/data/org")
...
(setq org-capture-templates
      '(("i" "Inbox"     entry (file "~/emacs-data/data/org/inbox.org")
         "* %?\n%U\n")
        ("t" "Todo"      entry (file "~/emacs-data/data/org/refile.org")
         "* TODO %?\n%U\n%a\n" :clock-in t :clock-resume t)
        ("r" "Respond"   entry (file "~/emacs-data/data/org/refile.org")
         "* NEXT Respond to %:from on %:subject\nSCHEDULED: %t\n%U\n%a\n"
         :clock-in t :clock-resume t :immediate-finish t)
        ("n" "Note"      entry (file "~/emacs-data/data/org/refile.org")
         "* %? :NOTE:\n%U\n%a\n" :clock-in t :clock-resume t)
        ("j" "Journal"   entry (file+datetree "~/emacs-data/data/org/diary.org")
         "* %?\n%U\n" :clock-in t :clock-resume t)
        ("m" "Meeting"   entry (file "~/emacs-data/data/org/refile.org")
         "* MEETING with %? :MEETING:\n%U" :clock-in t :clock-resume t)
        ("p" "Phone"     entry (file "~/emacs-data/data/org/refile.org")
         "* PHONE %? :PHONE:\n%U" :clock-in t :clock-resume t)
        ("h" "Habit"     entry (file "~/emacs-data/data/org/refile.org")
...
(setq org-agenda-diary-file "~/emacs-data/data/org/diary.org")
