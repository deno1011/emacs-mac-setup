...
- *org-reminders-cli*: =brew install ginqi7/formulae/org-reminders-cli= — eigenes CLI (nicht keith/reminders-cli!)
- *websocket-bridge* + *websocket*: Emacs-Abhängigkeiten — werden automatisch installiert
...
;; org-reminders-cli prüfen (brew install ginqi7/formulae/org-reminders-cli)
(unless (executable-find "org-reminders")
  (message "org-reminders: CLI fehlt — brew install ginqi7/formulae/org-reminders-cli"))
