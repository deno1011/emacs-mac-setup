...
;; -- Ollama (local, OpenAI-compatible, Intel + Apple Silicon) --------
;; Install: brew install ollama
;; Start:   ollama serve
;; Models:  ollama pull qwen2.5:14b  (recommended for Intel 64GB)
;;          ollama pull qwen2.5:7b   (faster)
;;          ollama pull qwen2.5:32b  (best quality, slower on Intel)
(let ((backend (gptel-make-openai "Ollama"
                  :stream t
                  :protocol "http"
  ...
  (setq my/gptel-backends
        (append my/gptel-backends
                `(("Llama 3.1 8B (Ollama)"  ,backend . llama3.1:8b)
                  ("Qwen2.5 7B (Ollama)"    ,backend . qwen2.5:7b)
                  ("Qwen2.5 14B (Ollama)"   ,backend . qwen2.5:14b)
                  ("Qwen2.5 32B (Ollama)"   ,backend . qwen2.5:32b)))))
