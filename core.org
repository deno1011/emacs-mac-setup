...
(defvar my/gptel-protected-files
  (list (expand-file-name "~/emacs-data/config/config.org")
...
(add-hook 'org-mode-hook
          (lambda ()
            (when (and buffer-file-name
                       (or (string-match-p "/emacs-data/config/" buffer-file-name)
                           (string-match-p "/emacs-data/data/org/" buffer-file-name))
...
(defun my/startup-sync ()
  ...
  (let* ((repo     (file-truename (expand-file-name "~/emacs-data")))
