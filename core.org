...
;; macOS trackpad sends momentum events after finger lift — catch boundary
;; signals silently so scrolling stops hard instead of bouncing and messaging.
(define-advice scroll-down (:around (orig &rest args) suppress-boundary)
  (condition-case nil (apply orig args) (beginning-of-buffer nil)))
(define-advice scroll-up (:around (orig &rest args) suppress-boundary)
  (condition-case nil (apply orig args) (end-of-buffer nil)))
#+end_src
