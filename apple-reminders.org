...
(defun my/apple-reminders--prefetch ()
  "Silently populate cache and write agenda file without opening the dashboard."
  (my/apple-reminders--jxa-async
   my/apple-reminders--fetch-script
   (lambda (raw)
     (condition-case nil
...
(run-with-idle-timer 3 nil #'my/apple-reminders--prefetch)
