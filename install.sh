...
echo "  Config:    $EMACS_D  ->  $SRC_DIR/emacs.d"
echo "  Data:      $DATA_DIR"
echo "  Secrets:   $SRC_DIR/emacs.d/secrets.el"
echo ""
echo "  First launch will run bootstrap.org:"
...
echo "    6. Generate starter content for any files still missing"
echo "    7. Load API keys (Gemini/Anthropic/OpenAI/Groq) from BW or Keychain"
echo ""
