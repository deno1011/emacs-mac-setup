...
#+begin_src emacs-lisp
;; `:demand t' forces elpaca to build this BEFORE the `org-mode-hook'
;; below can fire; otherwise the hook calls `git-auto-commit-mode' as a
;; void function (one of the errors the user hit on first install).
