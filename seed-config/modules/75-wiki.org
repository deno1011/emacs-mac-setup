...
;; Data-dir.el gate removed: 43c624b's `my/bootstrap-resolve-data-dir-now'
;; runs at the end of 10-bootstrap.org tangle, so `my/wiki-base-dir' is
;; built from the BW.Repo-derived `my/data-dir' (not the init.el default)
;; by the time THIS file (75-) loads.
(my/wiki-ensure-tree)
#+end_src
