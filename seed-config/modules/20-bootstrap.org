...
(declare-function my/task-shell "10-tasks")
#+end_src
...
calls =use-package= at load time is =30-core.org=. Putting the
...
=00= → =05= → =10= → =20= → …. =00-startfirst= and =10-tasks= make
             ...
             (my/task-shell
              ...
              (lambda (out)
                (let* ((s (and (stringp out) (string-trim out)))
                       ...
                       ;; this callback returns (see 10-tasks.org
                  ...
                  (cond
                   (session
                    ...
                    ;; value after `make-process' (10-tasks.org L545-547).
