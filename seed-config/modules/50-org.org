...
;; The data-dir.el gate that used to wrap this call (052dd15) is gone:
;; 43c624b's `my/bootstrap-resolve-data-dir-now' runs at the end of
;; 10-bootstrap.org tangle, so `my/data-dir' is the BW.Repo-derived
;; path by the time THIS file (50-) loads. Creating dirs now lands
;; them under the correct root.
(my/gtd-ensure-tree)
#+end_src
