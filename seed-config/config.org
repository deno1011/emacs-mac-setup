...
;; Bootstrap is invoked synchronously at the END of the 10-bootstrap
;; module's own tangled block (see Step 9 of modules/10-bootstrap.org)
...
;; loop continues on to 20-core / 50-org / 55-apple-reminders / etc.
